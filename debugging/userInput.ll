; ModuleID = 'debugging/userInput.c'
source_filename = "debugging/userInput.c"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [13 x i8] c"Entered: %d\0A\00", align 1
...
; <label>:7:                                      ; preds = %3
  ...
  %9 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i32 0, i32 0), i32 %8)
  ret i32 0
}
