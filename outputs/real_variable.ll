...
define i32 @main(i32) {
  ...
  %2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @0, i64 0, i64 0), double 1.300000e+00, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @1, i64 0, i64 0))
  %3 = load double, double* @f, align 8
  %4 = fcmp olt double %3, 2.000000e+00
  br i1 %4, label %5, label %7

; <label>:5:                                      ; preds = %1
  %6 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @2, i64 0, i64 0), i8* getelementptr inbounds ([24 x i8], [24 x i8]* @3, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @4, i64 0, i64 0))
  br label %7
